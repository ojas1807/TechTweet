    ...
    <div className="bg-gray-100">
      ...
      <div className="container mx-auto mt-4">
        <div className="carousel w-full">
          <div id="slide1" className="carousel-item relative w-full">
            ...
            <a href="#slide4" className="absolute left-0 btn btn-circle">
              ❮
            </a>
            <a href="#slide2" className="absolute right-0 btn btn-circle">
              ❯
            </a>
          </div>
          <div id="slide2" className="carousel-item relative w-full">
            ...
            <a href="#slide1" className="absolute left-0 btn btn-circle">
              ❮
            </a>
            <a href="#slide3" className="absolute right-0 btn btn-circle">
              ❯
            </a>
          </div>
          <div id="slide3" className="carousel-item relative w-full">
            <img
              src="https://images.unsplash.com/photo-1464582920526-52639da1ce12?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              className="w-full h-64 object-cover"
              alt="Top News 3"
            />
            <div className="absolute bottom-0 left-0 p-4 bg-opacity-60 bg-gray-900 text-white">
            ...
            <a href="#slide2" className="absolute left-0 btn btn-circle">
              ❮
            </a>
            <a href="#slide4" className="absolute right-0 btn btn-circle">
              ❯
            </a>
          </div>
        </div>
      ...
      <div className="container mx-auto mt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white shadow-md p-4">
            <img
              src="https://plus.unsplash.com/premium_photo-1665520347050-38570519c860?q=80&w=1973&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              className="w-full h-48 object-cover"
              alt="News 2"
            />
            <h3 className="text-xl font-semibold mt-4">
              Black Boards are missing{" "}
            </h3>
            <p className="text-gray-700 mt-2">
              Now a Days Colleges are missing Black Boards...
            </p>
            <a
              href="#"
              className="text-blue-600 hover:underline mt-4 inline-block"
          ...
          <div className="bg-white shadow-md p-4">
            <img
              src="https://images.unsplash.com/photo-1620458883441-3d278950d90b?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              className="w-full h-48 object-cover"
              alt="News 3"
            />
            <h3 className="text-xl font-semibold mt-4">
            ...
            <p className="text-gray-700 mt-2">
              This is a short description of the news. Click to read more...
            </p>
            <a
              href="#"
              className="text-blue-600 hover:underline mt-4 inline-block"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white shadow-md p-4">
            ...
            <p className="text-gray-700 mt-2">
              Not the Code Editor bit the THeme
            </p>
            <a
              href="#"
              className="text-blue-600 hover:underline mt-4 inline-block"
